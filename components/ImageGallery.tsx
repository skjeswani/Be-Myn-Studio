...
const ProgressLoader: React.FC = () => {
    ...
    useEffect(() => {
        // Simulate generation progress (approx 10 seconds for a more realistic pace)
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full w-full bg-gray-50 dark:bg-gray-900">
            <div className="relative w-16 h-16">
                ...
                <svg className="transform -rotate-90 w-full h-full" viewBox="0 0 64 64">
                    ...
                    <circle
                        ...
                        className="text-black dark:text-white transition-all duration-200 ease-linear"
                        strokeLinecap="round"
                    />
                </svg>
            ...
            <p className="mt-4 text-[10px] font-bold text-gray-400 uppercase tracking-widest animate-pulse">Creating...</p>
        </div>
    );
};
    ...
    return (
        <div className={`w-full group relative bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 overflow-hidden ${aspectClass}`}>
            ...
            <div className="absolute inset-0 bg-black/40 backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center gap-4">
                ...
                <button
                    onClick={handleShare}
                    className="p-4 rounded-full bg-white/10 hover:bg-white text-white hover:text-black border border-white/20 hover:border-white transition-all duration-200 backdrop-blur-md shadow-lg transform hover:scale-110"
                    title="Share Image"
                >
                ...
                >
                    {isCopied ? (
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-green-400 group-hover:text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        return (
             <div className="animate-fade-in space-y-6 w-full">
                <div className="flex justify-between items-center">
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white tracking-tight">GENERATED RESULTS</h3>
                    {hasGeneratedImages && (
                        <button
                            onClick={handleDownloadAll}
                            disabled={isZipping}
                            className="flex items-center bg-black dark:bg-white hover:bg-gray-800 dark:hover:bg-gray-200 text-white dark:text-black text-sm font-bold py-2 px-4 transition-colors duration-200 disabled:opacity-50 disabled:cursor-wait focus:outline-none"
                        >
