                ...
                <label htmlFor="instructions" className="text-xl font-semibold text-gray-900 dark:text-white">4. Instructions <span className="text-sm font-normal text-gray-500">(Optional)</span></label>
                 <div className="relative">
                    <textarea
                        ...
                        maxLength={100}
                        className="w-full h-20 p-3 bg-white dark:bg-black border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 placeholder-gray-400 dark:placeholder-gray-500 disabled:opacity-50 resize-none text-gray-900 dark:text-white"
                        disabled={isLoading}
                    />
                    <span className="absolute bottom-2 right-3 text-xs text-gray-400 dark:text-gray-500">
